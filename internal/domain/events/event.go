...
const (
	...
	RecommendationFeedbackUpdated     Type = "recommendation.feedback.updated"
	RecommendationDeliveryUpdated     Type = "recommendation.delivery.updated"
	...
	StudyAIContextCompleted           Type = "study.ai.context.completed"
)
